                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="flex flex-col text-right">
                            <span class="text-xs font-bold text-slate-900 leading-none">Administrator</span>
                            <span class="text-[10px] text-slate-400 font-medium mt-1">Full Access</span>
                        </div>
                        <div class="w-8 h-8 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center text-xs font-bold text-slate-700">AD</div>
                    </div>
                </div>
            </header>
