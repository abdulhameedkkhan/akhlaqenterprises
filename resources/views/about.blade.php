...
@section('content')
    ...
    <div class="relative bg-slate-900 py-32 overflow-hidden">
        <div class="absolute inset-0 opacity-20">
            <img src="{{ asset('images/hero.webp') }}" class="w-full h-full object-cover" alt="Background" width="1920" height="400" loading="lazy">
        </div>
        <div class="absolute inset-0 bg-gradient-to-b from-slate-900/60 to-slate-900"></div>
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <span class="inline-block py-1 px-4 rounded-full bg-blue-600/30 text-blue-400 text-sm font-black tracking-widest uppercase mb-6 border border-blue-500/30">{{ __('about.hero_badge') }}</span>
            <h1 class="text-4xl md:text-7xl font-black text-white mb-6 tracking-tighter">{{ __('about.hero_title') }}</h1>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                <div class="relative">
                    ...
                    <div class="relative z-10 space-y-8">
                        <div>
                            <span class="text-blue-600 dark:text-blue-400 font-black tracking-[0.2em] uppercase text-xs">{{ __('about.our_story_title') }}</span>
                            <h2 class="text-4xl md:text-5xl font-black text-slate-900 dark:text-white mt-4 tracking-tighter">{{ __('about.decades_title') }}</h2>
                        ...
                        <div class="space-y-6 text-slate-600 dark:text-slate-300 text-lg font-medium leading-relaxed text-justify">
                            <p>
                                {{ __('about.our_story_para1') }}
                            </p>
                            <p>
                                {{ __('about.our_story_para2') }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative group">
                    ...
                    <div class="relative z-10 rounded-[3rem] overflow-hidden shadow-2xl shadow-blue-500/10 border-8 border-white dark:border-slate-700">
                        <img src="{{ asset('images/processing.webp') }}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000" alt="State of the Art Processing Facility" width="600" height="400" loading="lazy">
                        <div class="absolute inset-x-0 bottom-0 bg-gradient-to-t from-slate-900/80 p-8">
                            <p class="text-white font-black tracking-widest uppercase text-sm italic">"{{ __('about.modern_quote') }}"</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-24 bg-slate-50 dark:bg-slate-900 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="max-w-4xl mx-auto text-center">
                <div class="mb-4">
                    <span class="text-blue-600 dark:text-blue-400 font-black tracking-[0.3em] uppercase text-xs">{{ __('about.certifications_title') }}</span>
                </div>
                <h2 class="text-4xl md:text-5xl font-black text-slate-900 dark:text-white mb-8 tracking-tighter">{{ __('about.our_mission_title') }}</h2>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                <div>
                    ...
                    <div class="text-blue-200">{{ __('about.years_exp') }}</div>
                </div>
                <div>
                    <div class="text-4xl font-bold mb-2">50+</div>
                    <div class="text-blue-200">{{ __('about.products_count') }}</div>
                </div>
                <div>
                    <div class="text-4xl font-bold mb-2">30+</div>
                    <div class="text-blue-200">{{ __('about.global_markets') }}</div>
                </div>
                <div>
                    <div class="text-4xl font-bold mb-2">100%</div>
                    <div class="text-blue-200">{{ __('about.quality_guaranteed') }}</div>
                </div>
            </div>
        </div>
    </section>
