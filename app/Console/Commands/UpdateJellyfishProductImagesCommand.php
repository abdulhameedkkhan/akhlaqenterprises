...
class UpdateJellyfishProductImagesCommand extends Command
{
    protected $signature = 'products:update-jellyfish-images {--dir= : Local folder path with product images}';

    protected $description = 'Set images for Jellyfish products from local folder';
    ...
    {
        return $this->runUpdate($this->option('dir') ?: $this->sourceDir, 'Jellyfish');
    }
