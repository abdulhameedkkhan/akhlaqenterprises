...
class UpdateShellsProductImagesCommand extends Command
{
    protected $signature = 'products:update-shells-images {--dir= : Local folder path with product images} {--only= : Comma-separated product names to update}';

    protected $description = 'Set images for Shells products from local folder (images named by product name)';
