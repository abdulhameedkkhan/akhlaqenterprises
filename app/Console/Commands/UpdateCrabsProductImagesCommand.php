...
class UpdateCrabsProductImagesCommand extends Command
{
    protected $signature = 'products:update-crabs-images {--dir= : Local folder path with product images}';

    protected $description = 'Set images for Crabs products from local folder';
    ...
    {
        return $this->runUpdate($this->option('dir') ?: $this->sourceDir, 'Crabs');
    }
