...
class UpdateShrimpsProductImagesCommand extends Command
{
    protected $signature = 'products:update-shrimps-images {--dir= : Local folder path with product images} {--only= : Comma-separated product names to update}';

    protected $description = 'Set images for Shrimps / Prawns products from local folder (images named by product name)';
