...
class UpdateSeaWaterProductImagesCommand extends Command
{
    protected $signature = 'products:update-sea-water-images {--dir= : Local folder path with product images} {--only= : Comma-separated product names to update}';

    protected $description = 'Set images for Sea Water Fish products from local folder (images named by product name)';
