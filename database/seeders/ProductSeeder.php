    ...
    public function run(): void
    {
        ...
        foreach ($data as $categoryName => $productList) {
            ...
            foreach ($productList as $productName) {
                ...
                // For now, using high-quality placeholder URLs that look professional
                // In a real scenario, we would download or use AI to generate these.
                // I will add a method to simulate gallery images.
                $gallery = [
                ...
                Product::updateOrCreate(
                    ...
                    [
                        ...
                        'description' => "Premium quality {$productName} sourced from the best harvesting grounds. Fresh, frozen, and processed under strict quality standards for global export.",
